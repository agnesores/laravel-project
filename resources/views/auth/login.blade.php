            ...
            <div class="card rounded rounded-5 p-2 border-pink">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <center>
                                <label for="email" class="text-pink m-1" data-translate-key="email">E-mail:</label>
                                <input id="email" type="email" class="form-control w-75 border-pink hover-effect text-center rounded rounded-4 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="row mb-3">
                            <center>
                            <label for="email" class="text-pink m-1" data-translate-key="password">Password:</label>
                            <input id="password" type="password" class="form-control w-75 hover-effect border-pink text-center rounded rounded-4 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input hover-effect border-pink" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>

                                    <label class="form-check-label" for="remember" style="font-size: 15px" data-translate-key="rememberMe">{{ __('Remember Me') }}</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-0 text-center">
                            <center>
                                <button type="submit" class="btn btn-pink w-25 my-2">
                                    {{ __('Login') }}
                                </button><br>

                                @if (Route::has('password.request'))
                                    <a class="text-dark-pink my-3" href="{{ route('password.request') }}" data-translate-key="forgotYourPassword">
